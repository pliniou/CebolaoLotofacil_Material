...
# Arquivos de saída
$outputFull = Join-Path $projectOutDir "Full_Project.md"
...
$outputBaseline = Join-Path $projectOutDir "Baseline_Profile.md"
$outputMisc = Join-Path $projectOutDir "Project_Misc.md"
$outputAssets = Join-Path $projectOutDir "Assets.md"
...
Write-Host "Consolidacao concluida com sucesso! Saida salva em: $projectOutDir" -ForegroundColor Cyan