...
# As regras abaixo são intencionalmente amplas. Bibliotecas como Retrofit e OkHttp usam
# reflexão extensivamente, o que torna difícil para o R8 determinar estaticamente qual
# código é usado. Essas regras são uma salvaguarda padrão para evitar falhas em tempo de execução.
